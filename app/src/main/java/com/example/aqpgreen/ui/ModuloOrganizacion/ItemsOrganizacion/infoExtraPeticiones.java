...
public class infoExtraPeticiones extends Fragment {
    private Button btncancel;
    private Button btnok;

    public infoExtraPeticiones() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        return inflater.inflate(R.layout.fragment_info_extra_peticiones, container, false);
    }
